...
function createForm() {  
    ...
    submitButton.setAttribute("onclick", "window.open('http://localhost:8001/token=abekedddddddd&payload=ddddddd****dddd&returnurl=http:/localhost:8002', '_self'); return false;"); 
